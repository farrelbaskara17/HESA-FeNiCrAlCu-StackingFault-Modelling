...
SFE_Fe = SFE_Fe.*XCr./XCr;
SFE_Ni = SFE_Ni.*XCr./XCr;
SFE_Cr = SFE_Cr.*XCr./XCr;
SFE_Al = SFE_Al.*XCr./XCr;
SFE_Cu = SFE_Cu.*XCr./XCr;

SFE_FeCr = SFE_FeCr.*XCr./XCr;
SFE_FeNi = SFE_FeNi.*XCr./XCr;
SFE_FeAl = SFE_FeAl.*XCr./XCr;
SFE_CrNi = SFE_CrNi.*XCr./XCr;
SFE_mg = SFE_mg.*XCr./XCr;
...
format bank; %ini apa? format penulisan yang menggunakan 2 desimal dibelakang koma
    ...
    xlswrite('masterdata3.xlsx', col_header, 'Sheet3', 'A1');
    xlswrite('masterdata3.xlsx', result, 'Sheet3', 'A1082');
