...
SFE_Fe = SFE_Fe.*XCu./XCu;
SFE_Ni = SFE_Ni.*XCu./XCu;
SFE_Cr = SFE_Cr.*XCu./XCu;
SFE_Al = SFE_Al.*XCu./XCu;
SFE_Cu = SFE_Cu.*XCu./XCu;

SFE_FeCr = SFE_FeCr.*XCu./XCu;
SFE_FeNi = SFE_FeNi.*XCu./XCu;
SFE_FeAl = SFE_FeAl.*XCu./XCu;
SFE_CrNi = SFE_CrNi.*XCu./XCu;
SFE_mg = SFE_mg.*XCu./XCu;
...
format bank; %ini apa? format penulisan yang menggunakan 2 desimal dibelakang koma
    ...
    xlswrite('masterdata3.xlsx', col_header, 'Sheet5', 'A1');
    xlswrite('masterdata3.xlsx', result, 'Sheet5', 'A1082');
